...
MINERGRACE: Graphene-based High Resolution Neural Interfaces
- Funded by: ERC Proof of Concept (PoC) Grant
- Duration: 12 months
- Amount: 150K Euro
...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/minergrace-npgs.webp" title="MINERGRACE — nano-patterned graphene sheets" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/minergrace-neural-interface.webp" title="MINERGRACE — high resolution neural interfaces" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
